...
public class BombardierTwo : Bombardier
{
    ...
    #region MonoBehaviour
        ...
        void Start()
        {
            ...
            m_BuildingColor = GameObject.FindGameObjectWithTag("Building").transform.Find("Point light two").GetComponent<Light>().color;
        ...
        void Update()
        {
            ...
            if (m_Ready == false)
            {
                ...
                {
                    m_TouchedBuilding.transform.Find("Point light two").GetComponent<Light>().color = transform.Find("Point light").GetComponent<Light>().color;
                    m_TouchedBuilding.transform.Find("Point light one").GetComponent<Light>().intensity = 1;
                }
                else if (m_TouchedBuilding != null)
                {
                    m_TouchedBuilding.transform.Find("Point light two").GetComponent<Light>().color = m_BuildingColor;
            ...
            {
                m_TouchedBuilding.transform.Find("Point light two").GetComponent<Light>().intensity = 3;
                m_TouchedBuilding.transform.Find("Point light one").GetComponent<Light>().intensity = 0;
            }
        }
